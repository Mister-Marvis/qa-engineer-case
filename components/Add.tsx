  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
      <input
        ...
        type="text"
        placeholder="Todo..."
        className="block w-full rounded-md border-0 px-3 py-2 text-neutral-900 shadow-sm ring-1 ring-inset ring-neutral-300 placeholder:text-neutral-400 focus:ring-1 focus:ring-inset focus:ring-indigo-600 dark:bg-neutral-800 dark:text-neutral-50 dark:ring-neutral-500"
      />
      <button
        type="submit"
